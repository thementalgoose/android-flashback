...
internal class CircuitMapperTest {
    ...
    fun `mapCircuit maps fields correctly`() {
        val input = tmg.flashback.domain.persistence.models.circuit.Circuit.model()
    ...
    fun `mapCircuit maps location to null if lat is null`() {
        val input = tmg.flashback.domain.persistence.models.circuit.Circuit.model(locationLat = null)
    ...
    fun `mapCircuit maps location to null if lng is null`() {
        val input = tmg.flashback.domain.persistence.models.circuit.Circuit.model(locationLng = null)
    ...
    fun `mapCircuitHistory maps fields correctly`() {
        val input = tmg.flashback.domain.persistence.models.circuit.CircuitHistory.model()
