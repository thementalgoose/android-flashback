...
internal class OverviewRaceMapperTest: BaseTest() {
    ...
    fun `RoundRaceResult maps fields correctly`() {
        ...
        val expected = mapOf(
            "driverId" to tmg.flashback.formula1.model.RaceRaceResult(
    ...
    fun `RoundSprintQualifyingResult maps fields correctly`() {
        ...
        val expected = mapOf(
            "driverId" to tmg.flashback.formula1.model.RaceSprintQualifyingResult(
                driver = mockDriver().toConstructorDriver(forRound),
    ...
    fun `RoundQualifyingResult maps fields correctly`() {
        ...
        val expectedQ1 = mapOf(
            "driverId" to tmg.flashback.formula1.model.RaceQualifyingResult(
                driver = mockDriver(driverId = "driverId").toConstructorDriver(1),
                time = "1:01.123".toLapTime(),
                position = 2
            ),
            "driverId2" to tmg.flashback.formula1.model.RaceQualifyingResult(
