...
interface ConfigureRSS_ViewModelInputs {
...
interface ConfigureRSS_ViewModelOutputs {
...
@HiltViewModel
internal class ConfigureRSS_ViewModel @Inject constructor(
    private val repository: RSSRepository,
    private val rssFeedController: RSSController,
    private val webNavigationComponent: WebNavigationComponent,
) : ViewModel(), ConfigureRSS_ViewModelInputs, ConfigureRSS_ViewModelOutputs {

    var inputs: ConfigureRSS_ViewModelInputs = this
    var outputs: ConfigureRSS_ViewModelOutputs = this
