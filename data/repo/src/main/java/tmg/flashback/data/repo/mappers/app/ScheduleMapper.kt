...
class ScheduleMapper @Inject constructor() {
    ...
    fun mapSchedule(schedule: tmg.flashback.data.persistence.models.overview.Schedule?): Schedule? {
    ...
    private fun mapScheduleWeather(schedule: tmg.flashback.data.persistence.models.overview.Schedule?): ScheduleWeather? {
