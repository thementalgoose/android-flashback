...
import tmg.flashback.data.persistence.models.drivers.DriverSeasonRaceWithConstructor
import tmg.flashback.data.persistence.models.drivers.DriverSeasonWithRaces
...
class DriverMapper @Inject constructor(
    ...
    fun mapDriver(history: tmg.flashback.data.persistence.models.drivers.DriverHistory?): DriverHistory? {
