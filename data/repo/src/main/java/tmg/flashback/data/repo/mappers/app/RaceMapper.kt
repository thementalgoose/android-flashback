...
import tmg.flashback.data.persistence.models.race.QualifyingDriverResult
import tmg.flashback.data.persistence.models.race.RaceDriverResult
import tmg.flashback.data.persistence.models.race.RaceInfoWithCircuit
import tmg.flashback.data.persistence.models.race.SprintQualifyingDriverResult
import tmg.flashback.data.persistence.models.race.SprintRaceDriverResult
...
class RaceMapper @Inject constructor(
    ...
    fun mapRaceInfo(data: tmg.flashback.data.persistence.models.race.Race): RaceInfo {
        return RaceInfo(
    ...
    fun mapRace(data: tmg.flashback.data.persistence.models.race.Race?): Race? {
    ...
    private fun mapFastestLap(fastestLap: tmg.flashback.data.persistence.models.race.FastestLap?): FastestLap? {
