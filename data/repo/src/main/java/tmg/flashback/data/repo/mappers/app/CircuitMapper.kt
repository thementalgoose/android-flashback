...
import tmg.flashback.data.persistence.models.circuit.CircuitRoundResultWithDriverConstructor
import tmg.flashback.data.persistence.models.circuit.CircuitRoundWithResults
...
class CircuitMapper @Inject constructor(
    ...
    fun mapCircuit(circuit: tmg.flashback.data.persistence.models.circuit.Circuit?): Circuit? {
    ...
    @Throws(NullPointerException::class)
    fun mapCircuitHistory(circuitHistory: tmg.flashback.data.persistence.models.circuit.CircuitHistory?): CircuitHistory? {
