...
import tmg.flashback.data.persistence.models.constructors.ConstructorSeasonDriverWithDriver
import tmg.flashback.data.persistence.models.constructors.ConstructorSeasonWithDrivers
...
class ConstructorMapper @Inject constructor(
    ...
    fun mapConstructor(history: tmg.flashback.data.persistence.models.constructors.ConstructorHistory?): ConstructorHistory? {
