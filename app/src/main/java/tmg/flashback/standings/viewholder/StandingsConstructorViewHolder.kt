...
import kotlinx.android.synthetic.main.view_standings_constructor.view.*
...
class StandingsConstructorViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
    fun bind(item: StandingsItem.Constructor, maxPoints: Int) {
