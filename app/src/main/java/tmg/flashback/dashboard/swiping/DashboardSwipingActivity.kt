...
class DashboardSwipingActivity: BaseActivity() {

    private val viewModel: DashboardSwipingViewModel by inject()
    private val seasonAdapter: DashboardSwipingFragmentAdapter =
        DashboardSwipingFragmentAdapter(this)

    override fun layoutId(): Int = R.layout.activity_dashboard_swiping
