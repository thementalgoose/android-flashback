...
class FirebasePushNotificationManager(
    ...
    private val prefNotificationDB: PrefNotificationDB
        ...
        return suspendCoroutine { continuation ->
            FirebaseMessaging
                ...
                .addOnCompleteListener {
                    if (it.isSuccessful) {
                        prefNotificationDB.notificationsRace = OPT_IN
                    }
    ...
    override suspend fun raceUnsubscribe(): Boolean {
        return suspendCoroutine { continuation ->
            FirebaseMessaging
                ...
                .addOnCompleteListener {
                    if (it.isSuccessful) {
                        prefNotificationDB.notificationsRace = OPT_OUT
                    }
                    continuation.resume(it.isSuccessful)
                }
        }
    ...
    override suspend fun qualifyingSubscribe(): Boolean {
        return suspendCoroutine { continuation ->
            FirebaseMessaging
                ...
                .addOnCompleteListener {
                    if (it.isSuccessful) {
                        prefNotificationDB.notificationsQualifying = OPT_IN
                    }
                    continuation.resume(it.isSuccessful)
                }
        }
    ...
    override suspend fun qualifyingUnsubscribe(): Boolean {
        return suspendCoroutine { continuation ->
            FirebaseMessaging
                ...
                .addOnCompleteListener {
                    if (it.isSuccessful) {
                        prefNotificationDB.notificationsQualifying = OPT_OUT
                    }
                    continuation.resume(it.isSuccessful)
                }
        }
    ...
    override suspend fun appSupportSubscribe(): Boolean {
        return suspendCoroutine { continuation ->
            FirebaseMessaging
                ...
                .addOnCompleteListener {
                    if (it.isSuccessful) {
                        prefNotificationDB.notificationsMisc = OPT_IN
                    }
                    continuation.resume(it.isSuccessful)
                }
        }
    ...
    override suspend fun appSupportUnsubscribe(): Boolean {
        return suspendCoroutine { continuation ->
            FirebaseMessaging
                ...
                .addOnCompleteListener {
                    if (it.isSuccessful) {
                        prefNotificationDB.notificationsMisc = OPT_OUT
                    }
                    continuation.resume(it.isSuccessful)
                }
        }
