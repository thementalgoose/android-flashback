package tmg.flashback.shared.driverlist
...
class DriverListStatAdapter: RecyclerView.Adapter<DriverListStatAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DriverListStatAdapter.ViewHolder {
        return ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.layout_constructor_driver_label, parent, false))
    }

    override fun onBindViewHolder(holder: DriverListStatAdapter.ViewHolder, position: Int) {
