...
internal val mockRound1Driver1Q1 = RoundQualifyingResult(driver = mockDriver1.toConstructorDriver(), time = LapTime(0,1, 1, 0), position = 1)
...
internal val mockRound1Driver1Q2 = RoundQualifyingResult(driver = mockDriver1.toConstructorDriver(), time = LapTime(0,1, 2, 0), position = 2)
...
internal val mockRound1Driver1Q3 = RoundQualifyingResult(driver = mockDriver1.toConstructorDriver(), time = LapTime(0,1, 1, 0), position = 1)
...
internal val mockRound1: Round = Round(
        ...
        name = "Round 1",
        drivers = listOf(
                mockDriver1.toConstructorDriver(),
...
internal val mockRound2Driver1Q1 = RoundQualifyingResult(driver = mockDriver1.toConstructorDriver(), time = LapTime(0,1, 3, 0), position = 3)
...
internal val mockRound2Driver1Q2 = RoundQualifyingResult(driver = mockDriver1.toConstructorDriver(), time = LapTime(0,1, 2, 0), position = 2)
...
internal val mockRound2Driver1Q3 = RoundQualifyingResult(driver = mockDriver1.toConstructorDriver(), time = LapTime(0,1, 2, 0), position = 4)
