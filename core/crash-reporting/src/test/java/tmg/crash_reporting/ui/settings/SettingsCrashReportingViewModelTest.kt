...
import tmg.test.assertListMatchesItem
    ...
    fun `init loads correct settings options`() {
        ...
        sut.outputs.settings.test {
            assertValue(listOf(
                ...
                AppPreferencesItem.SwitchPreference("CrashReporting", R.string.settings_crash_reporting_enabled_title, R.string.settings_crash_reporting_enabled_description, false),
                AppPreferencesItem.SwitchPreference("ShakeToReport", R.string.settings_crash_reporting_shake_to_report_title, R.string.settings_crash_reporting_shake_to_report_description, false),
            ))
        }
    }
