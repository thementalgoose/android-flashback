package tmg.flashback.ads.config.testutils

import androidx.annotation.StringRes
import org.junit.jupiter.api.Assertions
import tmg.flashback.ui.settings.SettingsModel

internal fun List<SettingsModel>.findSwitch(@StringRes title: Int): SettingsModel.SwitchPref {
    return this
        .first {
            when (it) {
...
internal fun List<SettingsModel>.findPref(@StringRes title: Int): SettingsModel.Pref {
    return this
        .first {
            when (it) {
...
internal fun List<SettingsModel>.assertExpectedOrder(expected: List<Pair<Int, Int?>>) {
